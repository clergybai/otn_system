...
class CheckVoa(EmptyModel):
    __tablename__ = "check_voa"
    ...
    va4_shelf_id = sa.Column(sa.VARCHAR(63), default=None)
    va4_slot_id = sa.Column(sa.VARCHAR(63), default=None)
    va4_port_id = sa.Column(sa.VARCHAR(63), default=None)
    ...
    def __init__(self, sys_name, sub_name, ne_id, shelf_id, slot_id,
                 va4_shelf_id, va4_slot_id,  va4_port_id, data_error,
        ...
        self.board_model = va4_shelf_id
        self.va4_slot_id = va4_slot_id
        self.va4_port_id = va4_port_id
