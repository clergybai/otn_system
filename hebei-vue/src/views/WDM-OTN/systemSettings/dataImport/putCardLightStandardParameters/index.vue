    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column
          align="center"
          label="标准增益最小值"
          prop="standard_gain_min"
        />
        <el-table-column
          align="center"
          label="标准增益最大值"
          prop="standard_gain_max"
        />
        <el-table-column
          align="center"
          label="40波系统-单波输出标准值"
          prop="standard_single_40_wave_output"
        />
        <el-table-column
          align="center"
          label="80波系统-单波输出标准值"
          prop="standard_single_80_wave_output"
        />
        <el-table-column
          align="center"
          label="96波系统-单波输出标准值"
          prop="standard_single_96_wave_output"
        />
      </el-table>
    </div>
    <el-pagination
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      getBoardStandard(data0).then((res) => {
        if (res.code == 200) {
