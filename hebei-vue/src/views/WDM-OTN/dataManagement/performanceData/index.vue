  ...
  methods: {
    ...
    exportor() {
      ...
      new Promise((resolve, reject) => {
        exportCheckPmData(data0).then((res) => {
          if (res.code == 200) {
            const data = res.data;
            for (const item of data) {
              ...
              list.out_power = item.out_power;
              list.in_power = item.in_power;
