...
class TopPowerMaxMin(EmptyModel):
    __tablename__ = "top_power_max_min"
    ...
    manual_optical_power_baseline = sa.Column(sa.Double, default=None)
    ...
    def __init__(self, source_ne_id, source_oa_shelf_id, source_oa_slot_id,
                 manual_optical_power_baseline, timestamp=datetime.now(), is_history=2):
        self.id = str(uuid.uuid4())
        self.source_ne_id = source_ne_id
        self.source_oa_shelf_id = source_oa_shelf_id
        self.source_oa_slot_id = source_oa_slot_id
        self.manual_optical_power_baseline = manual_optical_power_baseline
    ...
    @classmethod
    def get_top_power_max_mins(cls, **kwargs):
